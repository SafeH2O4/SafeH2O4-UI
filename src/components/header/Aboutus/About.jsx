  ...
  return (
    <div className="about">
      ...
      <div className="aboutcontent">
        <h1>About us</h1>
        <p>
          Welcome to Safe H2O4, where we are dedicated to providing you with the
          ...
          H2O4, we believe that access to clean water is a fundamental right.
          Our team of experts works tirelessly to develop advanced filtration
          ...
          Safe H2O4 for your home and experience the difference that pure, clean
